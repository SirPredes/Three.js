...
//         }
//     })
//     //scene.environmentIntensity = debugObject.envMapIntensity; //Se pot usar directament scene.environmentIntensity fora des bucle
// }
...
// gui.add(scene, 'environmentIntensity').min(0).max(4).step(0.001).onChange(updateAllMaterials)
