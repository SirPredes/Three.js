...
gltfLoader.load('./models.glb', (gltf) => {
    ...
    particles.points.frustumCulled = false //Aixo es lo que fa servir THREE.JS per renderitzar un objecte o no depenent si esta dins
                                            //s'angle de visio. Per aixo crea una esfera a nes seu voltant i fa es calculs amb ella.
                                            //Aqui com que canviam sa posicio dels vertex nomes, totes ses figures tenen sa esfera
                                            //de sa primera figura, per lo que hi ha popping quan sa primera hagues sortit de s'angle
                                            //de visio pero sa current no. En aquest cas ho podem desactivar, pero jo crec que a un 
                                            //projecte real aixo no aniria be perque se renderitzara tot sempre i es bad for performance
                                            // (realment es una cosa aquest metode) 
                                            //Be se veu que no es taaan dolent per sa performance perque encara que els intenti renderitzar
                                            //No en renderitzara cap perque no se veuen ( encara aixi no es lo millor per sa performance)
