...
var BilateralFilterPass = class extends Pass {
  constructor(input) {
    super("BilateralFilterPass", void 0, new Camera());
...
var GodraysCompositorMaterial = class extends ShaderMaterial {
  constructor({
    ...
    const uniforms = {
      ...
      godraysResolution: { value: new Vector2(1, 1) },
...
var GodraysCompositorPass = class extends Pass {
  constructor(props) {
    super("GodraysCompositorPass", void 0, new Camera());
  ...
  maybeInitDepthCopyRenderTarget(width, height) {
    ...
    this.depthCopyRenderTexture = new WebGLRenderTarget(width, height, {
...
var GodraysIllumPass = class extends Pass {
  ...
  checkForDepthCopy(renderer) {
    ...
    const isDirectionalOrSpot = light instanceof DirectionalLight || light.isDirectionalLight || light instanceof SpotLight || light.isSpotLight;
    ...
    if (hasCompareFunction) {
      ...
      this.depthCopyTarget = new WebGLRenderTarget(shadowMapSize.x, shadowMapSize.y);
      this.depthCopyTarget.depthTexture = new DepthTexture(
        shadowMapSize.x,
        shadowMapSize.y,
        UnsignedIntType
      );
      this.depthCopyTarget.depthTexture.format = DepthFormat;
      this.depthCopyTarget.depthTexture.compareFunction = null;
      this.depthCopyTarget.depthTexture.minFilter = NearestFilter;
      this.depthCopyTarget.depthTexture.magFilter = NearestFilter;
    } else {
      this.needsDepthCopy = false;
      this.originalShadowMap = null;
    }
  ...
  updateUniforms({ light, camera }, params) {
    ...
    if ((light instanceof DirectionalLight || light.isDirectionalLight) && ((_c = shadow.map) == null ? void 0 : _c.depthTexture)) {
...
var GodraysUpsampleQuality = ((GodraysUpsampleQuality2) => {
